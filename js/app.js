...
function updateCountdown() {
  ...
  if (now >= end) {
    finishCountdown("¡Gracias por compartir este día mágico! ✨");
    return;
  }

  if (now >= start) {
    finishCountdown("¡Hoy es el gran día! ✨", "La magia ya empezó.");
    return;
  }
  ...
  else countdownStatus.textContent = `Faltan ${days} días para celebrar juntos.`;
}
